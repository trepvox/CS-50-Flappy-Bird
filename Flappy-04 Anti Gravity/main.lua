...
--[[ New function used to check global input table for keys we activated during
this grame, looks up by their string values.]]
...
function love.update(dt)
    -- scroll background by preset seepd * dt. Loops back to 0 after loop point hit
    ...
    --reset input table before ending update
